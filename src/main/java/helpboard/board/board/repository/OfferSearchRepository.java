...
public interface OfferSearchRepository extends PagingAndSortingRepository<Offer, UUID> {
    ...
    @Query("SELECT new helpboard.board.board.rest.view.OfferListDto( " +
            "o.id, o.title, o.description, o.telephone, o.contactName, " +
            "v.value, o.city, o.freeSpaceFrom, o.freeSpaceTo, o.active, o.created) " +
            ...
            "and (:persons is null or o.freeSpaceFrom >= :persons)" +
            "and (:persons is null or o.freeSpaceTo <= :persons)")
